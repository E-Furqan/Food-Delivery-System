...
func ReadEnv() Environment {
	...
	envVar.DATABASE_HOST = utils.GetEnv("HOST", "db")
	envVar.DATABASE_USER = utils.GetEnv("USER1", "furqan")
	envVar.DATABASE_PASSWORD = utils.GetEnv("PASSWORD", "furqan")
	envVar.DATABASE_NAME = utils.GetEnv("DB_NAME", "Order")
